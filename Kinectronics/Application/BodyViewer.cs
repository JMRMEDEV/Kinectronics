namespace Kinectronics
{
    ...
    public sealed class BodyViewer
    {
        /// <summary>
        ...
        private readonly Brush kinectColor = new SolidColorBrush(Color.FromArgb(0, 112, 48, 160));
        ...
        public BodyViewer(KinectSensor kinectSensor)
        {
            ...
            this.bodyColors.Add(new Pen(Brushes.White, 6));
        ...
        public void UpdateBodyFrame(Body body)
        {
            if (body != null)
            {
                using (DrawingContext dc = this.drawingGroup.Open())
                {
                    ...
                    dc.DrawRectangle(kinectColor, null, new Rect(0.0, 0.0, this.displayWidth, this.displayHeight));
